...
namespace Tridium {
	...
	struct Color : public Vector4
	{
		...
		Color( float a_Value ) : Vector4( a_Value, a_Value, a_Value, 1.0f ) {}
		Color( float a_Red, float a_Green, float a_Blue, float a_Alpha = 1.0f ) : Vector4( a_Red, a_Green, a_Blue, a_Alpha ) {}
	};
