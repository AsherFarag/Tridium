...
#define _BEGIN_REFLECT_COMPONENT( Class, Flags ) \
 ...
 factory.prop( ::Tridium::Refl::Props::InitComponentProp::ID, +[]( ::Tridium::OldScene& a_Scene ) { a_Scene.__InitComponentType<ClassType>(); } ); \
 factory.prop( ::Tridium::Refl::Props::AddToGameObjectProp::ID, +[](::Tridium::OldScene& a_Scene, ::Tridium::EntityID a_GameObject) -> ::Tridium::Component* { return a_Scene.TryAddComponentToGameObject<ClassType>(::Tridium::OldGameObject{a_GameObject}); } ); \
 factory.prop( ::Tridium::Refl::Props::RemoveFromGameObjectProp::ID, +[](::Tridium::OldScene& a_Scene, ::Tridium::EntityID a_GameObject) { a_Scene.RemoveComponentFromGameObject<ClassType>(::Tridium::OldGameObject{a_GameObject}); } ); \
