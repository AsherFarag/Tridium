...
// Note: Has been modified by Tridium.

// Basic compiletime reflection for fields in an aggregate type.
...
namespace Tridium {
	...
	template <typename T1, typename T2, typename _Func,
		...
		field_reflection::field_referenceable U2 = std::remove_cvref_t<T2>>
		requires std::is_same_v<U1, U2>
    bool AllOfField( T1&& a_Object1, T2&& a_Object2, _Func&& a_Func )
    {
		return field_reflection::all_of_field( std::forward<T1>( a_Object1 ), std::forward<T2>( a_Object2 ), std::forward<_Func>( a_Func ) );
    }

	template <typename T, typename _Func, field_reflection::field_referenceable U = std::remove_cvref_t<T>>
    bool AllOfField( T&& a_Object, _Func&& a_Func )
    {
        return field_reflection::all_of_field( std::forward<T>( a_Object ), std::forward < _Func >( a_Func ) );
    }

	template <typename T1, typename T2, typename _Func, field_reflection::field_referenceable U1 = std::remove_cvref_t<T1>,
		field_reflection::field_referenceable U2 = std::remove_cvref_t<T2>>
		requires std::is_same_v<U1, U2>
	bool AnyOfField( T1&& a_Object1, T2&& a_Object2, _Func&& a_Func )
	{
		return field_reflection::any_of_field( std::forward<T1>( a_Object1 ), std::forward<T2>( a_Object2 ), std::forward<_Func>( a_Func ) );
	}

	template <typename T, typename _Func, field_reflection::field_referenceable U = std::remove_cvref_t<T>>
	bool AnyOfField( T&& a_Object, _Func&& a_Func )
	{
		return field_reflection::any_of_field( std::forward<T>( a_Object ), std::forward < _Func >( a_Func ) );
	}
