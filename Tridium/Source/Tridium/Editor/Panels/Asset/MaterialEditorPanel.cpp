...
namespace Tridium {
	...
	MaterialEditorPanel::MaterialEditorPanel( AssetID a_Material )
	...
	void MaterialEditorPanel::OnImGuiDraw()
	{
		...
		//if ( ImGuiBegin( flags ) )
		//{
		//	if ( ToolUI::DrawProperty( "Material", m_Material, EDrawPropertyFlags::Editable ) )
		//	{
		//		m_Modified = false;
		//	}
		...
		//		m_Modified |= ToolUI::DrawProperty( "Albedo Texture", material->AlbedoTexture, EDrawPropertyFlags::Editable );
		//		m_Modified |= ToolUI::DrawProperty( "Metallic Texture", material->MetallicTexture, EDrawPropertyFlags::Editable );
		//		m_Modified |= ToolUI::DrawProperty( "Roughness Texture", material->RoughnessTexture, EDrawPropertyFlags::Editable );
		//		m_Modified |= ToolUI::DrawProperty( "Normal Texture", material->NormalTexture, EDrawPropertyFlags::Editable );
		//		m_Modified |= ToolUI::DrawProperty( "Opacity Texture", material->OpacityTexture, EDrawPropertyFlags::Editable );
		//		m_Modified |= ToolUI::DrawProperty( "Emissive Texture", material->EmissiveTexture, EDrawPropertyFlags::Editable );
		//		m_Modified |= ToolUI::DrawProperty( "AO Texture", material->AOTexture, EDrawPropertyFlags::Editable );
		//	}
		//}
	...
	void MaterialEditorPanel::SetMaterial( AssetID a_Material )
	{
