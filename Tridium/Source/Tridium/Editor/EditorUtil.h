...
namespace Tridium::Util {
	...
	{
		Application::Get()->PushOverlay<SaveFileDialogLayer>( a_Callback, a_DefaultFilePath );
	}
	...
	{
		Application::Get()->PushOverlay<LoadFileDialogLayer>( a_Callback, a_DefaultFilePath );
	}
	...
	{
		Application::Get()->PushOverlay<NewFileDialogLayer>( a_FileTypeName, a_Callback, a_DefaultFilePath );
	}
};
