...
namespace Tridium::D3D12 {
	...
	// Helper function
	static DescriptorHeapRef CreateDescriptorHeap( ID3D12Device* a_Device, uint32_t a_NumDescriptors, ERHIDescriptorHeapType a_Type, EDescriptorHeapFlags a_Flags, bool a_IsGlobal, StringView a_DebugName = StringView{} )
	{
	...
	DescriptorHeapRef DescriptorHeapManager::AllocateIndependentHeap( ERHIDescriptorHeapType a_Type, uint32_t a_NumDescriptors, EDescriptorHeapFlags a_Flags, StringView a_DebugName )
	{
		// If this heap is poolable, attempt to find one in the pool.
		if ( EnumFlags( a_Flags ).HasFlag( EDescriptorHeapFlags::Poolable ) )
		{
	...
	DescriptorHeapRef DescriptorHeapManager::AllocateHeap( ERHIDescriptorHeapType a_Type, uint32_t a_NumDescriptors, EDescriptorHeapFlags a_Flags, StringView a_DebugName )
	{
	...
	void DescriptorHeapManager::AddHeapToPool( ComPtr<ID3D12DescriptorHeap>&& a_Heap, ERHIDescriptorHeapType a_Type, uint32_t a_NumDescriptors, EDescriptorHeapFlags a_Flags )
	{
