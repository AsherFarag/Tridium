...
#include <Tridium/Graphics/Rendering/Pipeline.h>
#include "Buffer.h"
...
namespace Tridium {
	...
	public:
		...
		virtual void SetLineWidth( float a_Width ) = 0;
		virtual void SetPolygonMode( EFaces a_Faces, EPolygonMode a_PolygonMode ) = 0;
